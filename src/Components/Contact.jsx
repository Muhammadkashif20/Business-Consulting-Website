  ...
  return (
    <div className="mx-32 my-5">
      <div className="relative">
        <img src={Rectangle} alt="" className="w-[70rem] h-[25rem]" />
        <div className="flex items-center gap-1 absolute bottom-[23rem] font-semibold text-[1rem] mx-3 mt-7">
       ...
       <div className="flex flex-col relative bottom-[22rem] mx-10 my-5">
        ...
        <div className="mt-12 flex gap-3">
          ...
          <input type="text" placeholder="Email Address" className=" placeholder:text-gray-600 text-sm mx-9 relative bottom-2  w-[12rem]"/>
          </div>
        ...
        <div className="relative bottom-[21rem] flex justify-end">
          <img src={Services} alt="" className="w-[30rem] h-[22rem]"/>
        </div>
        </div>
      </div>
    </div>
